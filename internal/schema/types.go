...
var cScalarTypeMap = map[string]TypeObj{
	"string":        {SchemaText: "string", GoText: "string", Family: TypeFamilyScalar, Kind: FieldKindString},
	"bool":          {SchemaText: "bool", GoText: "bool", Family: TypeFamilyScalar, Kind: FieldKindBool},
	"int":           {SchemaText: "int", GoText: "int", Family: TypeFamilyScalar, Kind: FieldKindIntSigned, IsNumeric: true, IsSigned: true},
	"int8":          {SchemaText: "int8", GoText: "int8", Family: TypeFamilyScalar, Kind: FieldKindIntSigned, BitSize: 8, IsNumeric: true, IsSigned: true},
	"int16":         {SchemaText: "int16", GoText: "int16", Family: TypeFamilyScalar, Kind: FieldKindIntSigned, BitSize: 16, IsNumeric: true, IsSigned: true},
	"int32":         {SchemaText: "int32", GoText: "int32", Family: TypeFamilyScalar, Kind: FieldKindIntSigned, BitSize: 32, IsNumeric: true, IsSigned: true},
	"int64":         {SchemaText: "int64", GoText: "int64", Family: TypeFamilyScalar, Kind: FieldKindIntSigned, BitSize: 64, IsNumeric: true, IsSigned: true},
	"uint":          {SchemaText: "uint", GoText: "uint", Family: TypeFamilyScalar, Kind: FieldKindIntUnsigned, IsNumeric: true},
	"uint8":         {SchemaText: "uint8", GoText: "uint8", Family: TypeFamilyScalar, Kind: FieldKindIntUnsigned, BitSize: 8, IsNumeric: true},
	"uint16":        {SchemaText: "uint16", GoText: "uint16", Family: TypeFamilyScalar, Kind: FieldKindIntUnsigned, BitSize: 16, IsNumeric: true},
	"uint32":        {SchemaText: "uint32", GoText: "uint32", Family: TypeFamilyScalar, Kind: FieldKindIntUnsigned, BitSize: 32, IsNumeric: true},
	"uint64":        {SchemaText: "uint64", GoText: "uint64", Family: TypeFamilyScalar, Kind: FieldKindIntUnsigned, BitSize: 64, IsNumeric: true},
	"float":         {SchemaText: "float", GoText: "float32", Family: TypeFamilyScalar, Kind: FieldKindFloat, BitSize: 32, IsNumeric: true, IsSigned: true, IsFloat: true},
	"float32":       {SchemaText: "float32", GoText: "float32", Family: TypeFamilyScalar, Kind: FieldKindFloat, BitSize: 32, IsNumeric: true, IsSigned: true, IsFloat: true},
	"float64":       {SchemaText: "float64", GoText: "float64", Family: TypeFamilyScalar, Kind: FieldKindFloat, BitSize: 64, IsNumeric: true, IsSigned: true, IsFloat: true},
	"duration":      {SchemaText: "duration", GoText: "time.Duration", Family: TypeFamilyScalar, Kind: FieldKindDuration, BitSize: 64, IsDuration: true, IsNumeric: true, IsSigned: true},
	"time.Duration": {SchemaText: "time.Duration", GoText: "time.Duration", Family: TypeFamilyScalar, Kind: FieldKindDuration, BitSize: 64, IsDuration: true, IsNumeric: true, IsSigned: true},
	"size":          {SchemaText: "size", GoText: "SizeObj", Family: TypeFamilyScalar, Kind: FieldKindSize, BitSize: 64, IsSize: true, IsNumeric: true},
}

var cMapTypeMap = map[string]TypeObj{
	"map[string]string":   {SchemaText: "map[string]string", GoText: "map[string]string", Family: TypeFamilyMap, Kind: FieldKindMapStringString, MapValueText: "string"},
	"map[string]any":      {SchemaText: "map[string]any", GoText: "map[string]any", Family: TypeFamilyMap, Kind: FieldKindMapStringAny, MapValueText: "any"},
	"map[string][]string": {SchemaText: "map[string][]string", GoText: "map[string][]string", Family: TypeFamilyMap, Kind: FieldKindMapStringStringArr, MapValueText: "[]string"},
}
...
func ParseType(typeText string, enumValueTextArr []string) (TypeObj, error) {
	...
	if strings.HasPrefix(typeText, "[]") {
		...
		return TypeObj{
			...
			Kind:           arrayKindFor(elemTypeObj.Kind),
			BitSize:        elemTypeObj.BitSize,
...
// ParseSize разбирает размер в байтах. Алгоритм совпадает с рантайм-функцией parseSize в
// сгенерированном пакете: целочисленный путь для целых значений (точный), float только при
// наличии дробной точки. Единый источник истины устраняет расхождение gen-time и runtime.
